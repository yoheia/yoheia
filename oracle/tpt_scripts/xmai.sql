...
--------------------------------------------------------------------------------
--
-- File name:   xmai (eXplain from Memory with object/QB alias, lookup by SQL ID)
--
...
column xms_object_alias     heading Object|Alias for a30
column xms_qblock_name      heading Query|Block for a30
...
select  --+ ordered use_nl(p ps)
    ...
    p.object_alias  xms_object_alias,
